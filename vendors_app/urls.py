...
urlpatterns = [
    ...
    path("purchase-orders/",views.PurchaseOrderCreateListView.as_view(),name="purchase_orders_create_list"),
    path("purchase-orders/<str:po_number>/",views.PurchaseOrderListUpdateDelete.as_view(),name="purchase_orders_update_show_delete"),
    path("vendors/<str:vendor_code>/performance",views.VendorPerformanceView.as_view(),name="vendor_performance"),
    path('purchase-orders/<str:po_id>/acknowledge',views.AcknowledgePurchaseOrderView.as_view(), name='acknowledge-purchase-order'),
